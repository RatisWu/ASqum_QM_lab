...
class Parameters(NodeParameters):
    ...
    # General:
    coupler_flux_min : float = -0.3 #0.100 #relative to the coupler set point
    coupler_flux_max : float = 0.3 #0.190 #relative to the coupler set point
    ...
    coupler_flux_step : float = 0.006 #0.0002
    qubit_flux_span : float = 0.1 #0.016 # relative to the known/calculated detuning between the qubits
    qubit_flux_step : float = 0.001 #0.0002  
    use_state_discrimination: bool = True
    pulse_duration_ns: int = 120 #240
